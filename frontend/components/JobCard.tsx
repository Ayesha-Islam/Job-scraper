...
export default function JobCard({ job }: JobCardProps) {
  return (
    <Card className="h-full flex flex-col hover:shadow-lg transition-shadow duration-200 border border-gray-200 gap-0">
      ...
      <CardFooter className="flex flex-col gap-3 pt-6">
        ...
        <div className="w-full flex gap-2">
          ...
          <a href={job.url} target="_blank" rel="noopener noreferrer" className="flex-1">
            <Button className="w-full text-sm h-9 gap-1.5" size="sm">
              Apply Now
